...
5. test_get_books_genre_returns_type_dict - проверяет, что возвращаются данные в правильном типе - словарь
...
11. test_get_list_of_favorites_books_returns_empty_list - проверяем, что список избранного - пустой список